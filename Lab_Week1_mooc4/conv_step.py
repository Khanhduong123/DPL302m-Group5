...
if __name__== '__main__':
    #Testing the first function: Padding X
    ...
    #Testing the function: convolutional computation
    print("\n\033[0m=========\n")
    print('Testing convolutional computation function:')
    np.random.seed(1)
    ...
    #Case:stride of 1
    print("\n\033[0m=========\n")
    print('Testing pool forward function with stride = 1:')
    print("CASE 1:\n")
    np.random.seed(1)
    ...
    # Case 2: stride of 2
    print("\n\033[0m=========\n")
    print('Testing pool forward function with stride = 2:')
    print("\n\033[0mCASE 2:\n")
    np.random.seed(1)
    ...
    # Test conv_backward
    print("\n\033[0m=========\n")
    print('Testing backward pass function:')
    ...
    #pool_backward
    print("\n\033[0m=========\n")
    print('Testing pool backward pass function:')
    np.random.seed(1)
