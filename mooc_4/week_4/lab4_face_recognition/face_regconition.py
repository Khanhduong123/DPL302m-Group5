...
def triplet_loss(y_true, y_pred, alpha = 0.2):
    ...
    Note: 
    tf.reduce_sum(): sum all elements in this tensor
    """
...
def who_is_it(image_path, database, model):
    ...
    # Initialize a thresh hold named "min_dist" to a large value, say 100 
    min_dist = 100
