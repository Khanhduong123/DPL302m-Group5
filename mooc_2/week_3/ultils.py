...
def linear_function():
    """
    This functions is implemented a linear function: 
...
def sigmoid(z):
    ...
    """
    This function is computes the sigmoid of z
...
def one_hot_matrix(label, depth=6):
    """
    This functions is computed the one hot encoding for a single label
    
    Inputs:
...
def initialize_parameters():
    """
    This function is initializes parameters to build a neural network with TensorFlow. The shapes are:
                        W1 : [25, 12288]
                        b1 : [25, 1]
                        W2 : [12, 25]
                        b2 : [12, 1]
...
def forward_propagation(X, parameters):
    """
    This functions is implemented the forward propagation for the model: LINEAR -> RELU -> LINEAR -> RELU -> LINEAR
...
def compute_total_loss(logits, labels):
    """
    This function is computes the total loss
    ...
    total_loss = tf.reduce_sum(tf.keras.metrics.categorical_crossentropy(tf.transpose(labels), 
                                                           tf.transpose(logits), 
                                                           from_logits=True ))    
